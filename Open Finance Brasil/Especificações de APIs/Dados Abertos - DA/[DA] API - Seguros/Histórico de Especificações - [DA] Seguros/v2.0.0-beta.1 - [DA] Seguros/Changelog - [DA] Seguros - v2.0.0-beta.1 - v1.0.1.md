---
id: 352256084
title: Changelog - [DA] Seguros - v2.0.0-beta.1 - v1.0.1
version: 2
modified: 2024-03-28T14:35:13.206Z
url: /spaces/OF/pages/352256084/Changelog+-+DA+Seguros+-+v2.0.0-beta.1+-+v1.0.1
---
...
| data/coverages[]/typeAdditionalInfos | Alterado - "minItem" | Alteração | 1 | 0 |
| /data[]/society/products[]/society/products[]/pmbacRemuneration/interestRate | Alterado - "pattern" | Alteração | ^(\d{1}\.\d{6})$|^(-1.000000)$​ | ^(\d{1}\.\d{6})$ |
| /data[]/society/products[]/reclaim/table[]/percentagem | Alterado - "pattern" | Alteração | ^(\d{1}\.\d{6})$|^(-1.000000)$​ | ^(\d{1}\.\d{6})$ |
| /data[]/society/products[]/reclaim/gracePeriod/unit | Alterado - Enum | Alteração | DIAS MESES NAO_APLICA | DIAS MESES |
| /data[]/society/products[]/otherGuaranteedValues[]​ | Alterado - Enum | Alteração | SALDAMENTO BENEFICIO_PROLONGADO NAO_APLICA | SALDAMENTO BENEFICIO_PROLONGADO |
| /data[]/society/products[]/portabilityGraceTime/unit​ | Alterado - Enum | Alteração | DIAS MESES NAO_APLICA | DIAS MESES |
| data[]/society/products[]/additionals | Alterado - nome do campo | Alteração | additionals | additionalServices​ |