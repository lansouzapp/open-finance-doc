---
id: 372834559
title: Changelog - [DA] Previdência- v2.0.0-beta.2 - v1.0.1
version: 3
modified: 2024-04-16T18:14:05.753Z
url: /spaces/OF/pages/372834559/Changelog+-+DA+Previd+ncia-+v2.0.0-beta.2+-+v1.0.1
---
...
| --- | --- | --- | --- | --- | --- | --- |
| get/responses/200/data | Adicionado - "description" | Adição | | Conjunto de informações referente ao produto previdência | PDA263 | |
| get/responses/200/data/items | Adicionado - minItens | Adição | | 1 | PDA255 | |
| get/responses/200/data/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items | Removido - name | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - code​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - segment​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - modality​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - additionalInfo​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - termsAndConditions | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - type​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - defferalPeriod​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - grantPeriodBenefit​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - costs​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - minimumRequirement​ | Remoção | | | PDA249 | |
| get/responses/200/data/items | Removido - targetAudience​ | Remoção | | | PDA249 | |
| get/responses/200/data/items/participant | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/participant/brand | Adicionado - "pattern" | Adição | | ^(?!\s)[\w\W\s]*[^\s]$ | PDA286 | |
| get/responses/200/data/items/participant/brand | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/participant/brand | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/participant/cnpjNumber | Adicionado - minLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/participant/cnpjNumber | Adicionado - maxLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/participant/cnpjNumber `​` | Alterado - Pattern | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/participant/cnpjNumber | Alterado - "pattern" | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/participant/name | Adicionado - "pattern" | Adição | | ^(?!\s)[\w\W\s]*[^\s]$ | PDA286 | |
| get/responses/200/data/items/participant/name | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/participant/name | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/participant/urlComplementaryList​ | Alterado - Pattern | Alteração | ^((https?:\/\/)?(www\.)?[-a-zA-Z0-9@:%. \+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:% \+.~#?&\/\/=]*))|(NA)$ | ^((https?:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*))$​ | PDA252 | |
| get/responses/200/data/items/participant/urlComplementaryList | Alterado - "pattern" | Alteração | ^((https?:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*))|(NA)$ | ^((https?:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*))$ | PDA252 | |
| get/responses/200/data/items/society | Alterado - "description" | Alteração | Conjunto de informações relativas à seguradora do produto de open insurance | Objeto que representa a empresa regulada pela SUSEP que oferta produtos definidos em OPIN | PDA276 | |
| get/responses/200/data/items/society | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society | Adicionado obrigatóriedade no campo 'products' | Adição | | required | PDA252 | |
| get/responses/200/data/items/society | Adicionado - products | Adição | | minItems: 1​ description: Lista de produtos de uma empresa. | PDA249 | |
| get/responses/200/data/items/society/brand​ | Adicionado - Brand | Adição | | Tipo: string​ maxLength: 80​ minLenght: 1 example: Marca no OPIN​ pattern: ^(?!\s)[\w\W\s]*[^\s]$​ Descrição: Nome da Marca reportada pelo participante do Open Insurance. O conceito a que se refere a 'marca' é em essência uma promessa da empresa em fornecer uma série específica de atributos, benefícios e serviços uniformes aos clientes​ Mandatoriedade do campo: Opcional ​ | PDA250 | |
| get/responses/200/data/items/society/cnpjNumber | Adicionado - minLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/society/cnpjNumber | Adicionado - maxLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/society/cnpjNumber​ | Alterado - Pattern | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/society/cnpjNumber | Alterado - "pattern" | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/society/name | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/name | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/society/products/items | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items | Removido obrigatóriedade no campo 'segment' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items | Removido obrigatóriedade no campo 'modality' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items | Removido obrigatóriedade no campo 'targetAudience' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items | Adicionado - name | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - code​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - segment​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - modality​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - additionalInfo​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - termsAndConditions | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - type​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - defferalPeriod​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - grantPeriodBenefit​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - costs​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - minimumRequirement​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items | Adicionado - targetAudience​ | Adição | | | PDA249 | |
| get/responses/200/data/items/society/products/items/additionalInfo | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/additionalInfo | Adicionado - maxLength | Adição | | 1024 | PDA253 | |
| get/responses/200/data/items/society/products/items/code | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/code | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/society/products/items/costs | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/costs/loadingAntecipated | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/costs/loadingLate | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod | Adicionado - premiumPaymentMethodsAdditionalInfo | Adição | | | PDA258 | |
| get/responses/200/data/items/society/products/items/defferalPeriod | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod | Removido obrigatóriedade no campo 'updateIndex' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/betweenPortabilityRequests | Alterado - "type" | Alteração | number | integer | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/betweenPortabilityRequests​ | Adicionado - minimum | Adição | | 0 | PDA254 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/betweenRedemptionRequests | Alterado - "type" | Alteração | number | integer | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/betweenRedemptionRequests​ | Adicionado - minimum | Adição | | 0 | PDA254 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/portability | Alterado - "type" | Alteração | number | integer | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/portability​ | Adicionado - minimum | Adição | | 0 | PDA254 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/redemption | Alterado - "type" | Alteração | number | integer | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/gracePeriod/redemption​ | Adicionado - minimum | Adição | | 0 | PDA254 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds | Adicionado - "description" | Adição | | Lista com as informações do(s) Fundo(s) de Investimento(s) disponíveis para o período de diferimento/acumulação ou de concessão | PDA263 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items | Adicionado - minItens | Adição | | 0 | PDA255 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items | Removido obrigatóriedade no campo 'typePerformanceFee' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/cnpjNumber | Adicionado - minLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/cnpjNumber | Adicionado - maxLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/cnpjNumber​ | Alterado - Pattern | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/cnpjNumber | Alterado - "pattern" | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/currency | Adicionado - minLength | Adição | | 3 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/currency | Adicionado - maxLength | Adição | | 3 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/currency​ | Alterado - Pattern | Alteração | ^([A-Z]{3})$|^(NA)$ | ^([A-Z]{3})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/currency | Alterado - "pattern" | Alteração | ^([A-Z]{3})$|^(NA)$ | ^([A-Z]{3})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumContributionAmount | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumContributionAmount | Adicionado - maxLength | Adição | | 21 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumContributionAmount​ | Alterado - Pattern | Alteração | ^(\d{1,16}\.\d{2,4})$​ | ^(\d{1,16}\.\d{2,4})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumContributionAmount | Alterado - "pattern" | Alteração | ^(\d{1,16}\.\d{2,4})$|^(NA)$ | ^(\d{1,16}\.\d{2,4})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumMathematicalProvisionAmount | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumMathematicalProvisionAmount | Adicionado - maxLength | Adição | | 21 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumMathematicalProvisionAmount​ | Alterado - Pattern | Alteração | ^(\d{1,16}\.\d{2,4})$​ | ^(\d{1,16}\.\d{2,4})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/minimumMathematicalProvisionAmount | Alterado - "pattern" | Alteração | ^(\d{1,16}\.\d{2,4})$|^(NA)$ | ^(\d{1,16}\.\d{2,4})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/name | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/name | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/properties | Adicionado - "minimumContributionValue" | Adição | | | PDA267 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/typePerformanceFee | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/typePerformanceFee | Adicionado - maxLength | Adição | | 20 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/typePerformanceFee/enum | Removido - "NAO_APLICA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/investmentFunds/items/typePerformanceFee/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums | Adicionado - "description" | Adição | | Valor mínimo do prêmio/contribuição aceita pela sociedade ao plano (identificar valor mensal e/ou aporte único) | PDA263 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items | Adicionado - minItens | Adição | | 0 | PDA255 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/amount​ | Alterado - Pattern | Alteração | ^(\d{1,16}\.\d{2,4})$​ | ^(\d{1,16}\.\d{2,4})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/amount | Alterado - "pattern" | Alteração | ^(\d{1,16}\.\d{2,4})$|^(NA)$ | ^(\d{1,16}\.\d{2,4})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/currency | Adicionado - minLength | Adição | | 3 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/currency | Adicionado - maxLength | Adição | | 3 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/currency​ | Alterado - Pattern | Alteração | ^([A-Z]{3})$|^(NA)$ | ^([A-Z]{3})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/currency | Alterado - "pattern" | Alteração | ^([A-Z]{3})$|^(NA)$ | ^([A-Z]{3})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicity | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicity | Adicionado - maxLength | Adição | | 20 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicity/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicityDescription | Alterado - "minLength" | Alteração | 1 | 5 | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicityDescription | Alterado - "maxLength" | Alteração | 20 | 15 | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicityDescription | Removido - "enum" | Remoção | | | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicityDescription | Adicionado - "description" | Adição | | Descrição da periodicidade do prêmio/contribuição | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/minimumPremiums/items/periodicityDescription | Adicionado - "pattern" | Adição | | ^(?!\s)[\w\W\s]*[^\s]$ | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/otherMinimumPerformanceGarantees | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/otherMinimumPerformanceGarantees | Adicionado - maxLength | Adição | | 12 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/portabilityPaymentTerm | Alterado - "type" | Alteração | number | integer | PDA262 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/portabilityPaymentTerm​ | Adicionado - minimum | Adição | | 0 | PDA254 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/premiumPaymentMethods | Adicionado - "description" | Adição | | Meio de pagamento escolhido pelo segurado | PDA263 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/premiumPaymentMethods/items | Adicionado - minItens | Adição | | 0 | PDA255 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/premiumPaymentMethods/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/properties | Adicionado - "otherMinGuaranteesPercentage" | Adição | | | PDA267 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/updateIndex | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/updateIndex | Adicionado - maxLength | Adição | | 20 | PDA253 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/updateIndex | Alterado - "description" | Alteração | Índice utilizado na atualização do prêmio e do capital segurado, caso critério de atualização por meio de índice: IPCA (IBGE); IGP-M (FGV); INPC (IBGE). Não se aplica NA | Índice utilizado na atualização do prêmio e do capital segurado, caso critério de atualização por meio de índice: IPCA (IBGE); IGP-M (FGV); INPC (IBGE). | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/updateIndex | Alterado - description | Alteração | Índice utilizado na atualização do prêmio e do capital segurado, caso critério de atualização por meio de índice: 1. IPCA (IBGE); 2. IGP-M (FGV); 3. INPC (IBGE). 4. Não se aplica | Índice utilizado na atualização do prêmio e do capital segurado, caso critério de atualização por meio de índice: 1. IPCA (IBGE); 2. IGP-M (FGV); 3. INPC (IBGE). | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/updateIndex/enum | Removido - "NAO_SE_APLICA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/defferalPeriod/updateIndex/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit | Removido obrigatóriedade no campo 'updateIndex' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/biometricTable | Adicionado - "description" | Adição | | Obrigatório caso modalidade de renda seja diferente de (PAGAMENTO_UNICO, RENDA_PRAZO_CERTO). Tábua biométrica é o instrumento que ... | PDA263 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/biometricTable/items | Adicionado - minItens | Adição | | 0 | PDA255 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/biometricTable/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/incomeModalities | Adicionado - "description" | Adição | | Modalidades de renda disponíveis para contratação. A considerar os seguintes domínios | PDA263 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/incomeModalities/items | Adicionado - minItens | Adição | | 1 | PDA255 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/incomeModalities/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds | Adicionado - "description" | Adição | | Lista com as informações do(s) Fundo(s) de Investimento(s) disponíveis para o período de diferimento/acumulação ou de concessão. | PDA263 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items | Adicionado - minItens | Adição | | 0 | PDA255 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items | Removido obrigatóriedade no campo 'typePerformanceFee' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/cnpjNumber | Adicionado - minLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/cnpjNumber | Adicionado - maxLength | Adição | | 14 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/cnpjNumber​ | Alterado - Pattern | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/cnpjNumber | Alterado - "pattern" | Alteração | ^(\d{14})$|^(NA)$ | ^\d{14}$ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/currency | Adicionado - minLength | Adição | | 3 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/currency | Adicionado - maxLength | Adição | | 3 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/currency​ | Alterado - Pattern | Alteração | ^([A-Z]{3})$|^(NA)$ | ^([A-Z]{3})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/currency | Alterado - "pattern" | Alteração | ^([A-Z]{3})$|^(NA)$ | ^([A-Z]{3})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/minimumContributionAmount​ | Alterado - Pattern | Alteração | ^(\d{1,16}\.\d{2,4})$​ | ^(\d{1,16}\.\d{2,4})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/minimumContributionAmount | Alterado - "pattern" | Alteração | ^(\d{1,16}\.\d{2,4})$|^(NA)$ | ^(\d{1,16}\.\d{2,4})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/minimumMathematicalProvisionAmount​ | Alterado - Pattern | Alteração | ^(\d{1,16}\.\d{2,4})$​ | ^(\d{1,16}\.\d{2,4})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/minimumMathematicalProvisionAmount | Alterado - "pattern" | Alteração | ^(\d{1,16}\.\d{2,4})$|^(NA)$ | ^(\d{1,16}\.\d{2,4})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/name | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/name | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/properties | Adicionado - "minimumContributionValue" | Adição | | | PDA267 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/typePerformanceFee | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/typePerformanceFee | Adicionado - maxLength | Adição | | 20 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/typePerformanceFee/enum | Removido - "NAO_APLICA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/investmentFunds/items/typePerformanceFee/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/updateIndex | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/updateIndex | Adicionado - maxLength | Adição | | 20 | PDA253 | |
...
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/updateIndex/enum | Removido - "NAO_SE_APLICA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/grantPeriodBenefit/updateIndex/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/minimumRequirement | Adicionado - "description" | Adição | | Requerimento mínimo do serviço contratado | PDA263 | |
| get/responses/200/data/items/society/products/items/minimumRequirement | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/minimumRequirement | Removido obrigatóriedade no campo 'contractType' | Remoção | required | | PDA252 | |
| get/responses/200/data/items/society/products/items/minimumRequirement/contractingMinRequirement | Adicionado - "pattern" | Adição | | ^(https:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)$ | PDA286 | |
| get/responses/200/data/items/society/products/items/minimumRequirement/contractingMinRequirement | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/minimumRequirement/contractingMinRequirement | Adicionado - maxLength | Adição | | 1024 | PDA253 | |
| get/responses/200/data/items/society/products/items/minimumRequirement/contractType | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/minimumRequirement/contractType | Adicionado - maxLength | Adição | | 30 | PDA253 | |
| get/responses/200/data/items/society/products/items/minimumRequirement/contractType | Alterado - "description" | Alteração | O tipo de serviço contratado. A considerar os domínios abaixo: Coletivo Averbado; Coletivo instituído; Individual. NA | O tipo de serviço contratado. A considerar os domínios abaixo: Coletivo Averbado; Coletivo instituído; Individual. | PDA252 | |
| get/responses/200/data/items/society/products/items/minimumRequirement/contractType/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/modality | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/modality | Adicionado - maxLength | Adição | | 20 | PDA253 | |
| get/responses/200/data/items/society/products/items/modality | Alterado - "description" | Alteração | Contribuição Variável; Benefício Definido. NA | Contribuição Variável; Benefício Definido. | PDA252 | |
| get/responses/200/data/items/society/products/items/modality/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/name | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/name | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/society/products/items/segment | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/segment | Adicionado - maxLength | Adição | | 20 | PDA253 | |
| get/responses/200/data/items/society/products/items/segment | Alterado - "description" | Alteração | Segmento do qual se trata o produto contratado Seguro de Pessoas Previdência NA | Segmento do qual se trata o produto contratado Seguro de Pessoas Previdência | PDA252 | |
| get/responses/200/data/items/society/products/items/segment/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/targetAudience | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/targetAudience | Adicionado - maxLength | Adição | | 30 | PDA253 | |
| get/responses/200/data/items/society/products/items/targetAudience | Alterado - "description" | Alteração | A considerar os domínios abaixo: Pessoa Natural Pessoa Jurídica NA | A considerar os domínios abaixo: Pessoa Natural Pessoa Jurídica | PDA252 | |
| get/responses/200/data/items/society/products/items/targetAudience/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/items/society/products/items/termsAndConditions | Adicionado - "description" | Adição | | Conjunto de informações referente aos termos e condições conforme número do processo SUSEP | PDA263 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items | Adicionado - minItens | Adição | | 1 | PDA255 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items | Adicionado - maxItens | Adição | | 2147483647 | PDA255 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items | Adicionado - "x-regulatory-required" | Adição | | | PDA252 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items/contractTermsConditions | Adicionado - "pattern" | Adição | | ^(https:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)$ | PDA286 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items/detail | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items/detail | Adicionado - maxLength | Adição | | 1024 | PDA253 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items/susepProcessNumber | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items/susepProcessNumber | Adicionado - maxLength | Adição | | 30 | PDA253 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items/susepProcessNumber​ | Alterado - Pattern | Alteração | ^(\d{5}\.\d{6}\/\d{4}-\d{2}$|^\d{2}\.\d{6}\/\d{2}-\d{2}$|^\d{3}-\d{5}\/\d{2}$|^\d{5}\.\d{6}\/\d{2}-\d{2})$|^(NA)$ | ^(\d{5}\.\d{6}\/\d{4}-\d{2}$|^\d{2}\.\d{6}\/\d{2}-\d{2}$|^\d{3}-\d{5}\/\d{2}$|^\d{5}\.\d{6}\/\d{2}-\d{2})$​ | PDA252 | |
| get/responses/200/data/items/society/products/items/termsAndConditions/items/susepProcessNumber | Alterado - "pattern" | Alteração | ^(\d{5}\.\d{6}\/\d{4}-\d{2}$|^\d{2}\.\d{6}\/\d{2}-\d{2}$|^\d{3}-\d{5}\/\d{2}$|^\d{5}\.\d{6}\/\d{2}-\d{2})$|^(NA)$ | ^(\d{5}\.\d{6}\/\d{4}-\d{2}$|^\d{2}\.\d{6}\/\d{2}-\d{2}$|^\d{3}-\d{5}\/\d{2}$|^\d{5}\.\d{6}\/\d{2}-\d{2})$ | PDA252 | |
| get/responses/200/data/items/society/products/items/type | Adicionado - "example" | Adição | | PGBL | PDA264 | |
| get/responses/200/data/items/society/products/items/type | Adicionado - minLength | Adição | | 1 | PDA253 | |
| get/responses/200/data/items/society/products/items/type | Adicionado - maxLength | Adição | | 80 | PDA253 | |
| get/responses/200/data/items/society/products/items/type | Alterado - "description" | Alteração | PGBL PRGP PAGP PRSA PRI PDR VGBL VRGP VAGP 10. VRSA 11. VRI 12. VDR 13. Demais produtos de Previdência. 14. NA | PGBL PRGP PAGP PRSA PRI PDR VGBL VRGP VAGP 10. VRSA 11. VRI 12. VDR 13. Demais produtos de Previdência. | PDA252 | |
| get/responses/200/data/items/society/products/items/type/enum | Removido - "NA" | Remoção | enum | | PDA252 | |
| get/responses/200/data/society/products/defferalPeriod/minimumPremi ums/items/periodicity | Alterado - nome do campo | Alteração | periodicity | periodicityDescription | PDA260 | |
| get/responses/200/data/society/products/termsAndConditions/items/detail | Alterado - nome do campo | Alteração | detail | contractTermsCond itions | PDA260 | |