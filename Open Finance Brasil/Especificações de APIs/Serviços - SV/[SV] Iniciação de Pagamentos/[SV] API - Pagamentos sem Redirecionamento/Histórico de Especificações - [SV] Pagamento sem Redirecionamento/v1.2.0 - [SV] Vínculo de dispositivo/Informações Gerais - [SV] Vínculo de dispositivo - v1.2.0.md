---
id: 212008982
title: Informações Gerais - [SV] Vínculo de dispositivo - v1.2.0
version: 3
modified: 2023-12-06T16:45:57.917Z
url: /spaces/OF/pages/212008982/Informa+es+Gerais+-+SV+V+nculo+de+dispositivo+-+v1.2.0
---
...
- Idempotência - v3.0.0 - Pagamentos
- Recomendação Uso de Polling e Controle de Acesso - v3.0.0 - Pagamentos
- Como Assinar o Payload - v3.0.0 - Pagamentos
- Assinatura de Mensagem vs Idempotência - v3.0.0 - Pagamentos
- Validação de informações no DICT - v3.0.0 - Pagamentos
- Convenções de formatação e fuso horário de campos de data e hora - v3.0.0 - Pagamentos