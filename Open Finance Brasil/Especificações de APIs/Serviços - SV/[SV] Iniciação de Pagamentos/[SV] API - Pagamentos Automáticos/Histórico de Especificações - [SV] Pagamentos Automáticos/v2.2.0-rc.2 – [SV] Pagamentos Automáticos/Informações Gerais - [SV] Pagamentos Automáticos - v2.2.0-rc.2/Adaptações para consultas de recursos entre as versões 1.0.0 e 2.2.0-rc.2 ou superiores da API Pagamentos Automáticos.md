---
id: 1123877105
title: Adaptações para consultas de recursos entre as versões 1.0.0 e 2.2.0-rc.2 ou superiores da API Pagamentos Automáticos
version: 1
modified: 2025-09-11T20:48:13.610Z
url: /spaces/OF/pages/1123877105/Adapta+es+para+consultas+de+recursos+entre+as+vers+es+1.0.0+e+2.2.0-rc.2+ou+superiores+da+API+Pagamentos+Autom+ticos
---
