---
id: 628195819
title: Changelog - [SV] Pagamentos Automáticos - v2.0.0-beta.1 - v1.0.0
version: 1
modified: 2024-10-11T15:18:37.438Z
url: /spaces/OF/pages/628195819/Changelog+-+SV+Pagamentos+Autom+ticos+-+v2.0.0-beta.1+-+v1.0.0
---
...
| get/responses/200/data/items/properties | Adicionado - "lastRetryRecurringPaymentIds" | Adição | | |
...
| post/requestBody/data/properties | Adicionado - "lastRetryRecurringPaymentIds" | Adição | | |
...
| post/requestBody/data/riskSignals/automatic/lastLoginDateTime | Alterado - "description" | Alteração | Data e hora do último login do cliente na iniciadora | Data e hora da última interação do cliente com o aplicativo/sistema da instituição iniciadora. |
...
| post/responses/201/data/properties | Adicionado - "lastRetryRecurringPaymentIds" | Adição | | |
...
| get/responses/200/data/properties | Adicionado - "lastRetryRecurringPaymentIds" | Adição | | |
...
| patch/responses/200/data/properties | Adicionado - "lastRetryRecurringPaymentIds" | Adição | | |
...
| post/responses/201/data/properties | Adicionado obrigatóriedade no campo 'startDateTime' | Adição | | required |
...
| | | | | |
| get/parameters/x-fapi-interaction-id | Alterado - "description" | Alteração | Um UUID [RFC4122]( https://tools.ietf.org/html/rfc4122 ) usado como um ID de correlação entre request e response. Campo de geração e... | Um UUID [RFC4122]( https://tools.ietf.org/html/rfc4122 ) usado como um ID de correlação entre request e response. Campo de geração e... |
| get/responses/200/data/properties | Adicionado obrigatóriedade no campo 'startDateTime' | Adição | | required |
...
| patch/responses/200/data/properties | Adicionado obrigatóriedade no campo 'startDateTime' | Adição | | required |
