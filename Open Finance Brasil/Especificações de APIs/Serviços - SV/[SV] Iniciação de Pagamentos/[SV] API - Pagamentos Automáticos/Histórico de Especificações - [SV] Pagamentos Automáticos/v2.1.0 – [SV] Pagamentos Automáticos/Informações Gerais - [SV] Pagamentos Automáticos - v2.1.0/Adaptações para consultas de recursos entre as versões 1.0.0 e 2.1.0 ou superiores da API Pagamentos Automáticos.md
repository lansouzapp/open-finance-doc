---
id: 931037407
title: Adaptações para consultas de recursos entre as versões 1.0.0 e 2.1.0 ou superiores da API Pagamentos Automáticos
version: 4
modified: 2025-05-05T20:54:16.032Z
url: /spaces/OF/pages/931037407/Adapta+es+para+consultas+de+recursos+entre+as+vers+es+1.0.0+e+2.1.0+ou+superiores+da+API+Pagamentos+Autom+ticos
---
...
- Não será permitido que o consentimento de um pagamento criado utilizando os endpoints da versão 2.1.0 seja consultado usando o endpoint GET/recurring-consents/{recurringConsentId} da versão 1.0.0; Neste cenário, deve-se retornar o código de erro HTTP 400.
