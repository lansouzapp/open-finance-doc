---
id: 239337786
title: Validação de informações no DICT - v4.0.0-beta.4 - [SV] Pagamentos
version: 1
modified: 2023-12-14T19:31:18.912Z
url: /spaces/OF/pages/239337786/Valida+o+de+informa+es+no+DICT+-+v4.0.0-beta.4+-+SV+Pagamentos
---

A detentora de conta poderá optar em qual momento e se realizará validações no DICT.**Opção 1: Criação do Pagamento - POST /pix/payments (síncrona)**Neste cenário o pagamento não é criado, porém o consentimento é consumido e está com o status CONSUMED.
