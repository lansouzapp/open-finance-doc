---
id: 194314265
title: Informações Gerais - API Admin - v2.0.0-rc.1
version: 2
modified: 2023-10-18T14:35:26.560Z
url: /spaces/OF/pages/194314265/Informa+es+Gerais+-+API+Admin+-+v2.0.0-rc.1
---
...
**Visão de alto nível das estruturas de dados****Dicionário de Dados**[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/draft-openapi/dictionary/getMetrics_v2.csv)