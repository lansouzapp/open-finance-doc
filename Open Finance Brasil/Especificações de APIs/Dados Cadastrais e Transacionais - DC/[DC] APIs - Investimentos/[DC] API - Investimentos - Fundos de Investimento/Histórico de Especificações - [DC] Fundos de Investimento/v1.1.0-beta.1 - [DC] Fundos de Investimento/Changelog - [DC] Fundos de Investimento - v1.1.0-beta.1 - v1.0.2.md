---
id: 1115783504
title: Changelog - [DC] Fundos de Investimento - v1.1.0-beta.1 - v1.0.2
version: 2
modified: 2025-09-08T19:18:21.079Z
url: /spaces/OF/pages/1115783504/Changelog+-+DC+Fundos+de+Investimento+-+v1.1.0-beta.1+-+v1.0.2
---
...
| --- | --- | --- | --- | --- |
| get/responses/200 | Adicionado - "headers" | Adição | | |
| get/responses/200/data/cnpjNumber | Alterado - "pattern" | Alteração | ^\d{14}$ | ^[0-9A-Z]{12}[0-9]{2}$ |
| get/responses/200/links/first | Alterado - "format" | Alteração | uri | url |
| get/responses/200/links/first | Alterado - "maxLength" | Alteração | 2000 | 4048 |
| get/responses/200/links/first | Removido - "pattern" | Remoção | ^(https:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)$ | |
| get/responses/200/links/last | Alterado - "format" | Alteração | uri | url |
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get/parameters/fromTransactionConversionDate | Alterado - "description" | Alteração | Data inicial de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo toTransactionConversionDate seja informado.... | Data inicial de filtragem. [Restrição] Deve obrigatoriamente sempre ser enviado em conjunto com o campo `toTransactionConversion... |
| get/parameters/toTransactionConversionDate | Alterado - "description" | Alteração | Data final de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo fromTransactionConversionDate seja informado.... | Data final de filtragem. [Restrição] Deve obrigatoriamente sempre ser enviado em conjunto com o campo `fromTransactionConversionD... |
| get/parameters/x-fapi-interaction-id | Alterado - "description" | Alteração | Um UUID RFC4122 usado como um ID de correlação entre request e response. Campo de geração e envio obrigatório pela receptora (clie... | Um UUID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação entre request e response. Campo de geração e... |
