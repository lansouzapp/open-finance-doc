---
id: 474578965
title: Informações Gerais - [DC] Direitos Creditórios Descontados - v2.2.2
version: 2
modified: 2024-07-04T15:10:38.556Z
url: /spaces/OF/pages/474578965/Informa+es+Gerais+-+DC+Direitos+Credit+rios+Descontados+-+v2.2.2
---

none**Visão Geral**A API Invoice-financings viabiliza o compartilhamento de informações das Operações de Crédito do tipo Direitos Creditórios Descontados.
