---
id: 1130333224
title: Changelog - [DC] Cartão de Crédito - v2.4.0-beta.1 - v2.3.1
version: 2
modified: 2025-09-15T17:58:59.953Z
url: /spaces/OF/pages/1130333224/Changelog+-+DC+Cart+o+de+Cr+dito+-+v2.4.0-beta.1+-+v2.3.1
---
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois | N° Proposta |
| --- | --- | --- | --- | --- | --- |
| get/parameters/fromTransactionDate | Alterado - "description" | Alteração | Data inicial de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo toTransactionDate seja informado. Caso não ... | Data final de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo `toTransactionDate` seja informado. Caso não... | PDC585 |
| get/parameters/toTransactionDate | Alterado - "description" | Alteração | Data final de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo fromTransactionDate seja informado. Caso não ... | Data inicial de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo `fromTransactionDate` seja informado. Caso... | PDC585 |
| get/parameters/transactionType | Alterado - "description" | Alteração | Traz os tipos de Transação | Traz os tipos de transações. O tipo `PAGAMENTO_FATURA` deve ser utilizado para pagamentos parciais (liberação de limite ou pagamen... | PDC570 |
| get/parameters/transactionType/enum | Adicionado - "PAGAMENTO_FATURA" | Adição | | enum | PDC570 |
