---
id: 1323696308
title: Changelog - [DC] Cartão de Crédito - v2.4.0-beta.2 - v2.3.1
version: 2
modified: 2025-11-28T13:25:28.561Z
url: /spaces/OF/pages/1323696308/Changelog+-+DC+Cart+o+de+Cr+dito+-+v2.4.0-beta.2+-+v2.3.1
---
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get/responses/200/data/paymentMethod | Alterado - "description" | Alteração | Listagem dos cartões (ex.: virtual/adicional/titular) associados a conta cartão consentida, conforme disponíveis ao usuário nos ca... | Listagem dos cartões (ex.: virtual/adicional/titular) associados a conta cartão consentida, conforme disponíveis ao usuário nos ca... |
| get/responses/200/data/paymentMethod | Alterado - "minItems" | Alteração | 1 | |
| get/responses/200/links/first | Alterado - "format" | Alteração | uri | url |
| get/responses/200/links/first | Alterado - "maxLength" | Alteração | 2000 | 4048 |
| get/responses/200/links/first | Removido - "pattern" | Remoção | ^(https:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)$ | |
| get/responses/200/links/last | Alterado - "format" | Alteração | uri | url |
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get/responses/200/data/items/properties | Adicionado obrigatóriedade no campo 'billClosingDate' | Adição | | required |
| get/responses/200/data/items/properties | Adicionado - "billClosingDate" | Adição | | |
| get/responses/200/data/items/billId | Alterado - "description" | Alteração | Informação que identifica a fatura | Código único e imutável que identifica a fatura. |
| get/responses/200/data/items/payments | Alterado - "description" | Alteração | Lista que traz os valores relativos aos pagamentos da Fatura da conta de pagamento pós-paga | Lista que traz os valores relativos aos pagamentos da Fatura da conta de pagamento pós-paga. Pagamentos efetuados a partir do mome... |
| get/responses/200/links/first | Alterado - "format" | Alteração | uri | url |
| get/responses/200/links/first | Alterado - "maxLength" | Alteração | 2000 | 4048 |
| get/responses/200/links/first | Removido - "pattern" | Remoção | ^(https:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)$ | |
| get/responses/200/links/last | Alterado - "format" | Alteração | uri | url |
...
## GET /accounts/{creditCardAccountId}/bills/{billsId}/transactions

### Request

| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get/parameters/fromTransactionDate | Alterado - "description" | Alteração | Data inicial de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo toTransactionDate seja informado. Caso não ... | Data final de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo `toTransactionDate` seja informado. Caso não... |
| get/parameters/toTransactionDate | Alterado - "description" | Alteração | Data final de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo fromTransactionDate seja informado. Caso não ... | Data inicial de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo `fromTransactionDate` seja informado. Caso... |
| get/parameters/transactionType | Alterado - "description" | Alteração | Traz os tipos de Transação | Traz os tipos de transações. O tipo `PAGAMENTO_FATURA` deve ser utilizado para pagamentos parciais (liberação de limite ou pagamen... |
| get/parameters/transactionType/enum | Adicionado - "PAGAMENTO_FATURA" | Adição | | enum |

### Response

| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get/responses/200/data/items/billId | Alterado - "description" | Alteração | Informação que identifica a fatura onde consta a transação informada. | Código único e imutável que identifica a fatura onde consta a transação informada. |
| get/responses/200/data/items/transactionType | Alterado - "description" | Alteração | Traz os tipos de Transação | Traz os tipos de transações. O tipo `PAGAMENTO_FATURA` deve ser utilizado para pagamentos parciais (liberação de limite ou pagamen... |
| get/responses/200/data/items/transactionType/enum | Adicionado - "PAGAMENTO_FATURA" | Adição | | enum |
| get/responses/200/links/first | Alterado - "format" | Alteração | uri | url |
| get/responses/200/links/first | Alterado - "maxLength" | Alteração | 2000 | 4048 |
| get/responses/200/links/first | Removido - "pattern" | Remoção | ^(https:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)$ | |
| get/responses/200/links/last | Alterado - "format" | Alteração | uri | url |
...
| get/responses/200/data/items/transactionDateTime | Alterado - "description" | Alteração | Data e hora da transação disponível para os clientes nos canais digitais da instituição. Neste momento, é obrigatório preencher co... | Data e hora da transação. Nas compras parceladas, o `transactionDateTime` deve ser idêntico em todas as parcelas. O campo deve... |
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get/responses/200/data | Alterado - "description" | Alteração | [Restrição] A lista vazia deve ser interpretada como a ausência da informação. Cenário de limite com valor zerado, deve ter um re... | [Restrição] O envio dos dados de limites deve seguir as seguintes orientações: - A lista vazia deve ser interpretada como a ausênc... |
| get/responses/200/data/items/usedAmount | Alterado - "description" | Alteração | Valor utilizado do limite informado | Valor utilizado do limite informado. Limites extras fornecidos ou contratados e usados pelo cliente devem ser somados neste campo... |
| get/responses/200/links/first | Alterado - "format" | Alteração | uri | url |
| get/responses/200/links/first | Alterado - "maxLength" | Alteração | 2000 | 4048 |
| get/responses/200/links/first | Removido - "pattern" | Remoção | ^(https:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&\/\/=]*)$ | |
| get/responses/200/links/last | Alterado - "format" | Alteração | uri | url |
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get | Alterado - "description" | Alteração | Método para obter a lista de transações histórica (últimos 12 meses, ou recorte desse período) da conta de pagamento pós-paga iden... | Método para obter a lista de transações histórica (últimos 12 meses, ou recorte desse período) da conta de pagamento pós-paga iden... |
| get/parameters/fromTransactionDate | Alterado - "description" | Alteração | Data inicial de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo toTransactionDate seja informado. Caso não ... | Data inicial de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo `toTransactionDate` seja informado. Caso n... |
| get/parameters/toTransactionDate | Alterado - "description" | Alteração | Data final de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo fromTransactionDate seja informado. Caso não ... | Data final de filtragem. [Restrição] Deve obrigatoriamente ser enviado caso o campo `fromTransactionDate` seja informado. Caso n... |
| get/parameters/transactionType | Alterado - "description" | Alteração | Traz os tipos de Transação | Traz os tipos de transações. O tipo `PAGAMENTO_FATURA` deve ser utilizado para pagamentos parciais (liberação de limite ou pagamen... |
| get/parameters/transactionType/enum | Adicionado - "PAGAMENTO_FATURA" | Adição | | enum |
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get/responses/200/data/items/amount | Alterado - "description" | Alteração | Valor original da transação. Expresso em valor monetário com no mínimo 2 casas decimais e no máximo 4 casas decimais. Deve ser sem... | Valor original da transação. Expresso em valor monetário com no mínimo 2 casas decimais e no máximo 4 casas decimais. Deve ser se... |
| get/responses/200/data/items/billId | Alterado - "description" | Alteração | Informação que identifica a fatura onde consta a transação informada. Preencher apenas para casos de transação em fatura fechada, ... | Código único e imutável que identifica a fatura onde consta a transação informada. Preencher apenas para casos de transação em fa... |
| get/responses/200/data/items/brazilianAmount | Alterado - "description" | Alteração | Valor da transação expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais, em moeda corrente do Brasil. De... | Valor da transação expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais, em moeda corrente do Brasil. D... |
| get/responses/200/data/items/transactionId | Alterado - "description" | Alteração | Código ou identificador único prestado pela instituição que mantém a conta para representar a transação individual. O ideal é que... | Código ou identificador único e imutável prestado pela instituição que mantém a conta para representar a transação individual. Só... |
| get/responses/200/data/items/transactionType | Alterado - "description" | Alteração | Traz os tipos de Transação | Traz os tipos de transações. O tipo `PAGAMENTO_FATURA` deve ser utilizado para pagamentos parciais (liberação de limite ou pagamen... |
| get/responses/200/data/items/transactionType/enum | Adicionado - "PAGAMENTO_FATURA" | Adição | | enum |
| get/responses/200/links/first | Alterado - "format" | Alteração | uri | url |
| get/responses/200/links/first | Alterado - "maxLength" | Alteração | 2000 | 4048 |
...
| Campo | O que foi alterado? | Tipo da Alteração | Antes | Depois |
| --- | --- | --- | --- | --- |
| get | Alterado - "description" | Alteração | Método para obter a lista de transações recentes (últimos 7 dias) da conta de pagamento pós-paga identificada por creditCardAccoun... | Método para obter a lista de transações recentes (últimos 7 dias) da conta de pagamento pós-paga identificada por `creditCardAccou... |
