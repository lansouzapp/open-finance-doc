---
id: 146669587
title: Informações Gerais - Webhook - v1.0.0-rc.2
version: 1
modified: 2023-07-24T20:17:12.038Z
url: /spaces/OF/pages/146669587/Informa+es+Gerais+-+Webhook+-+v1.0.0-rc.2
---
...
**Detentora**A detentora de conta fará no máximo 3 tentativas de notificação:
...
 **ITP**A iniciadora de pagamentos, ao perceber que não está recebendo as notificações oriundas da detentora de contas, poderá utilizar os endpoints de consulta para obter informações sobre o andamento de uma determinada transação do consentimento e/ou pagamento.