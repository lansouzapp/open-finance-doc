---
id: 1276740898
title: Cenário 8: payroll-credit-portability_api_user-accepted-counteroffer_test-module_v1 - CF
version: 2
modified: 2025-12-01T17:15:05.018Z
url: /spaces/OF/pages/1276740898/Cen+rio+8+payroll-credit-portability_api_user-accepted-counteroffer_test-module_v1+-+CF
---

| Tipo do teste | Teste funcional |
| Descrição | Cancelamento de solicitação de portabilidade após aceite de contraproposta |
| Objetivo | Garante que a credora rejeite pedido de solicitação portabilidade após cliente aceitar a contraproposta |
...
| 10 | Serão feitas a chamadas de endpoint GET /portabilities/{portabilityId} a cada 10 minutos enquanto status estiver em "RECEIVED" | Status 200 - Validação de resposta de acordo com a especificação e data.status igual "PENDING" | Etapa de contraproposta |
| 11 | Serão feitas a chamadas de endpoint GET /portabilities/{portabilityId} a cada 10 minutos enquanto status estiver em "PENDING" | Status 200 - Validação de resposta de acordo com a especificação e data.status igual "REJECTED" e data.rejection.rejectedBy como "CREDORA" e statusReason.reasonType como "RETENCAO_DO_CLIENTE" |
| 13 | Fim do teste | | |
