---
id: 1276740653
title: Cenário 3: payroll-credit-portability_api_contract-no-sign_test-module_v1 - CF
version: 2
modified: 2025-12-01T17:14:13.359Z
url: /spaces/OF/pages/1276740653/Cen+rio+3+payroll-credit-portability_api_contract-no-sign_test-module_v1+-+CF
---
...
| Objetivo | Garante que o pedido de portabilidade não será criado devido a falta de assinatura |
...
| 9 | Chamada de endpoint POST /portabilities endpoint enviando os seguintes valores: data.institution.creditor.companyCnpj = original companyCnpj instalmentPeriodicity = original instalmentPeriodicity proposedContract.totalNumberOfInstalments = original dueInstalments contractAmount = original contractOutstandingBalance Not including the /data/proposedContract/digitalSignatureProof field | Status 422 - Esperando o código de erro como "SEM_EVIDENCIA_ASSINATURA" | Etapa de criação de solicitação de portabilidade |
| 10 | Fim do teste | | |
