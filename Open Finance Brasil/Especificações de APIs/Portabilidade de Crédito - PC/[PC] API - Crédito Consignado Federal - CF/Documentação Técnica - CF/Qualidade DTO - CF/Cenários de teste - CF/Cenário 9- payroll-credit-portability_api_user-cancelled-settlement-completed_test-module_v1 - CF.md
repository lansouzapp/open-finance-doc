---
id: 1276740957
title: Cenário 9: payroll-credit-portability_api_user-cancelled-settlement-completed_test-module_v1 - CF
version: 2
modified: 2025-12-01T17:15:14.812Z
url: /spaces/OF/pages/1276740957/Cen+rio+9+payroll-credit-portability_api_user-cancelled-settlement-completed_test-module_v1+-+CF
---
...
| Objetivo | Garante que a cliente não possa cancelar um pedido de solicitação portabilidade após liquidação ter sido realizada. |
...
| 14 | Chamada de endpoint PATCH /portabilities/{portabilityId}/cancel enviando rejectedBy como "USUARIO" e reason.type como "CANCELADO_PELO_CLIENTE" | Status 422 - Esperando código de erro como "CANCELAMENTO_NAO_EFETUADO" | Etapa de cancelamento de solicitação de portabilidade de crédito |
| 15 | Fim do teste | | |
