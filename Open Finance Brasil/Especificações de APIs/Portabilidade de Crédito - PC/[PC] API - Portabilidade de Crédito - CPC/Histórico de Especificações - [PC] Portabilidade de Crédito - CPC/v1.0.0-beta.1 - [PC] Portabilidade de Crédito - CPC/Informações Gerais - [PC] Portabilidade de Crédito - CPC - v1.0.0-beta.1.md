---
id: 905740785
title: Informações Gerais - [PC] Portabilidade de Crédito - CPC - v1.0.0-beta.1
version: 3
modified: 2025-04-07T13:53:06.375Z
url: /spaces/OF/pages/905740785/Informa+es+Gerais+-+PC+Portabilidade+de+Cr+dito+-+CPC+-+v1.0.0-beta.1
---
...
### Dicionário de dados
Campos de resposta do endpoint de /portabilities/{portabilityId}/cancel.[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/openapi/dictionary/creditPortabilityPostPortabilitiesPortabilityIdCancel_v1.0.0.csv)
