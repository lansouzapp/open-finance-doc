---
id: 1477282992
title: v.19.00.01 Requisitos e Recomendações - Pix - Jornada Básica de Iniciação de Pagamento
version: 1
modified: 2026-01-23T17:46:40.837Z
url: /spaces/OF/pages/1477282992/v.19.00.01+Requisitos+e+Recomenda+es+-+Pix+-+Jornada+B+sica+de+Inicia+o+de+Pagamento
---

Requisitos e recomendações para a jornada de pagamento imediato com Pix via Open Finance. Este subcapítulo está organizado em cinco etapas principais — **Solicitação de Iniciação de Pagamento, Direcionamento ITP > ID, Confirmação, Redirecionamento ID > ITP e Efetivação**— com foco no seguinte cenário: 
